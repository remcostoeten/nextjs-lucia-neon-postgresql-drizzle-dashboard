...
export async function createTask(
    ...
    try {
        ...
        if (!newTask) {
            throw new Error('Task creation failed: No task returned from database')
        }
...
export async function updateTask(task: Task): Promise<Task> {
    try {
        ...
        if (!updatedTask) {
            throw new Error('Task update failed: No task returned from database')
        }
...
export async function removeSubtask(taskId: string, subtaskId: string): Promise<void> {
    try {
        ...
        const updatedSubtasks = (task.subtasks as Subtask[]).filter(subtask => subtask.id !== subtaskId)
...
export async function updateTaskTimeTracking(taskId: string, actualTime: number): Promise<void> {
    try {
        await db
            .update(tasks)
