...
>(({ className, ...props }, ref) => (
	<NavigationMenuPrimitive.List
		ref={ref}
		className={cn(
			'group flex flex-1 list-none items-center justify-center data-[orientation=vertical]:flex-col data-[orientation=horizontal]:space-x-1',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<NavigationMenuPrimitive.Content
		ref={ref}
		className={cn(
			'right-0 top-0 w-full md:absolute md:w-auto',
			...
			'data-[orientation=vertical]:data-[motion=from-end]:slide-in-from-top-52 data-[orientation=vertical]:data-[motion=from-start]:slide-in-from-bottom-52 data-[orientation=vertical]:data-[motion=to-end]:slide-in-from-top-52 data-[orientation=vertical]:data-[motion=to-start]:slide-in-from-bottom-52',
			className
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<div
		className={cn(
			...
			props.orientation === 'vertical' && 'left-full top-0'
		)}
	>
		<NavigationMenuPrimitive.Viewport
			className={cn(
				'origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border bg-popover text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)]',
				props.orientation === 'vertical' && 'ml-1.5 mt-0',
				className
			)}
			ref={ref}
			{...props}
