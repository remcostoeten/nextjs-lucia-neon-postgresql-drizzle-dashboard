...
export default function IntroShortcutGuide({ user }: DashboardIntroProps) {
    ...
    const { toggleAllAnimations, toggleSidebarAnimations } = useSiteSettingsStore()
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <Card className="mb-8">
                <CardHeader>
                    <CardTitle>Welcome to Your Dashboard, {user.name || user.email}</CardTitle>
                    <CardDescription>Here are some quick shortcuts to get you started:</CardDescription>
                </CardHeader>
                <CardContent>
                    <Flex dir="col" gap="4">
                        <Flex align="center" gap="2">
                            <Kbd variant="cmd" size="md">H</Kbd>
                            <span>Go to Home</span>
                        </Flex>
                        <Flex align="center" gap="2">
                            <Kbd variant="cmd" size="md">Shift</Kbd>
                            <Kbd size="md">P</Kbd>
                        ...
                        <Flex align="center" gap="2">
                            <Kbd variant="shift" size="md">L</Kbd>
                            <span>Logout</span>
                        </Flex>
                    </Flex>
                </CardContent>
