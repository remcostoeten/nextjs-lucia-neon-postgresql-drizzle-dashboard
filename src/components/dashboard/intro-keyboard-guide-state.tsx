...
export default function IntroKeyboardGuideState() {
    ...
    return (
        <div className="text-subtitle pr-8 animate-fade-in">
            <h2 className="text-2xl font-semibold mb-8 hidden md:block">Shortcuts</h2>
            ...
            <div className="bg-card border mt-8 p-10 rounded-2xl">
                ...
                <p className="text-neutral-200 mb-6">
                    Star us on Github.If you have any questions, please don't hesitate to  contact me through there.
                </p>

                <Flex gap='2' wrap='wrap'>
                    <Button className=" font-medium transition-colors duration-150">
                        <Link href="https://github.com/remcostoeten/nextjs-lucia-neon-postgresql-drizzle-dashboard">Go to Github</Link>

                    </Button>
                    <a href="mailto:stoetenremco.rs@gmail.com" className="inline-block bg-card hover:bg-card font-medium transition-colors duration-150 p-2 rounded">
                        Contact Us
                    </a>
                </Flex>
            </div>
