...
export default function TaskManagement() {
    ...
    const filteredAndSortedTasks = tasks
        .filter(task => {
            ...
            const labelMatch = labelFilter === 'all' || task.labels.includes(labelFilter)
    ...
    const tasksByStatus = {
        backlog: filteredAndSortedTasks.filter(task => task.status === 'backlog'),
            ...
            <div className="container mx-auto p-4 bg-[#1C1C1C] text-white min-h-screen">
                ...
                <div className="flex flex-wrap justify-between items-center mb-6 gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Select value={labelFilter} onValueChange={(value: string | 'all') => setLabelFilter(value)}>
                            <SelectTrigger className="w-[180px] bg-[#2C2C2C] text-white border-gray-600">
                        ...
                        <Select value={sortBy} onValueChange={(value: 'dueDate' | 'priority' | 'createdAt') => setSortBy(value)}>
                            <SelectTrigger className="w-[180px] bg-[#2C2C2C] text-white border-gray-600">
                        ...
                        <CreateTaskPopover onTaskCreated={fetchTasks} labels={labels} />
                    </div>
                </div>
