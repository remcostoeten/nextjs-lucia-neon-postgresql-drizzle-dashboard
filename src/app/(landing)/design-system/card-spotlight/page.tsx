...
import { Card, CardContent, CardHeader, CardTitle, Checkbox, Label, Slider } from '@/components/ui';
...
const CardControls = ({ rippleProps, onRipplePropsChange, theme }) => (
    <Card className={`${theme.bgCard} ${theme.borderColor}`}>
        <CardHeader>
            <CardTitle className={`text-lg ${theme.textPrimary}`}>Card Settings</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 flex-col">
            <div className="flex items-center space-x-2">
                <Checkbox
                    ...
                    onCheckedChange={(checked) => onRipplePropsChange({ ...rippleProps, enabled: checked })}
                />
                <Label htmlFor="ripple-enabled" className={theme.textPrimary}>Enable Ripple Effect</Label>
            </div>
            <div className="space-y-2">
                ...
                <Slider
                    ...
                    onValueChange={([value]) => onRipplePropsChange({ ...rippleProps, mainCircleSize: value })}
                />
            </div>
            <div className="space-y-2">
                ...
                <Slider
                    ...
                    onValueChange={([value]) => onRipplePropsChange({ ...rippleProps, mainCircleOpacity: value })}
                />
            </div>
            <div className="space-y-2">
                ...
                <Slider
                    ...
                    onValueChange={([value]) => onRipplePropsChange({ ...rippleProps, numCircles: value })}
                />
            </div>
        </CardContent>
    </Card>
...
export default function SpotlightPage() {
    ...
    return (
        <DesignSystemWrapper
            ...
            actionButtons={[]}
        >
            <main className={`relative flex min-h-screen flex-col border-outline rounded-lg overflow-hidden ${theme.bgMain}`}>
                        ...
                        <div className="space-y-8">
                            {cardData.map((card, index) => (
                                <CardControls
                                    ...
                                    onRipplePropsChange={(newProps) => handleRipplePropsChange(index, newProps)}
                                    theme={theme}
                                />
                            ))}
                        </div>
