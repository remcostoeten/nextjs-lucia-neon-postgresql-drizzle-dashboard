    ...
    >
      ...
      <div className="flex h-full flex-col items-center text-center">
        ...
        <div className="mb-5 grow">
          <h2 className={`mb-1 text-xl font-bold ${theme.textPrimary}`}>
            {title}
          </h2>
    ...
    <CardContent className="space-y-4 flex-col">
      <div className="flex items-center space-x-2">
        <Checkbox
          ...
          onCheckedChange={(checked) =>
            onRipplePropsChange({ ...rippleProps, enabled: checked })
          }
        />
      ...
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={([value]) =>
            onRipplePropsChange({ ...rippleProps, mainCircleSize: value })
          }
        />
      </div>
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={([value]) =>
            onRipplePropsChange({ ...rippleProps, mainCircleOpacity: value })
          }
        />
      </div>
      <div className="space-y-2">
        ...
        <Slider
          ...
          onValueChange={([value]) =>
            onRipplePropsChange({ ...rippleProps, numCircles: value })
          }
        />
      </div>
    </CardContent>
