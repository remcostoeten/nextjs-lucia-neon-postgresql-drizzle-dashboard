    ...
    return (
        ...
        >
            <div className="space-y-8">
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4">Custom Message Error Alert</h3>
                    <NoticeBox
                        title="Unable to save changes"
                        actionText="Retry Save"
                        onAction={handleTryAgain}
                    />
                    <CodeHighlight language="tsx" title="Custom Message Error Alert Usage">
                        {`<NoticeBox 
  title="Unable to save changes" 
  actionText="Retry Save"
  onAction={handleTryAgain}
/>`}
                ...
                <div>
                    <h3 className="text-lg font-semibold mb-4">Custom Icon Error Alert</h3>
                    <NoticeBox
                        icon={<AlertCircle />}
