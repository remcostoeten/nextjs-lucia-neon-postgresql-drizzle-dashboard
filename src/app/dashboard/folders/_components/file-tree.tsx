...
const FileTree: React.FC = () => {
	...
	const [editingFolder, setEditingFolder] = useState<TreeViewElement | null>(
		null
	)
	...
	const handleDeleteFolder = async () => {
		if (editingFolder) {
			try {
				...
				setElements(prev =>
					removeElementFromTree(prev, editingFolder.id)
				)
	...
	const updateElementInTree = (
		...
		updatedElement: TreeViewElement
	): TreeViewElement[] => {
					...
					<div className="space-y-4">
						...
						<div>
							...
							<Input
								...
								onChange={e =>
									setNewFolderColor(e.target.value)
								}
								className="mt-1"
							/>
						</div>
