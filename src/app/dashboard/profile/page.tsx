      ...
      <div className="space-y-8">
        <section>
          ...
          <div className="flex flex-wrap gap-4">
            <ThemeButton theme="light" label="Light" onClick={setTheme}>
            ...
            <ThemeButton theme="dark" label="Dark" onClick={setTheme}>
            ...
            <ThemeButton theme="system" label="System" onClick={setTheme}>
