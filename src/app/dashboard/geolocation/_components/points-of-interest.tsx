...
import { ScrollArea,Button, Card, CardContent, CardHeader, CardTitle } from 'ui'
        ...
        <ScrollArea className="h-[300px] rounded-md border p-4">
          {filteredPoints.map((point, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-400">{point.type}</p>
              <div className="mt-2 space-y-1">
                ...
                {point.phone && (
                  <div className="flex items-center">
                    ...
                    <a href={`tel:${point.phone}`} className="text-sm hover:underline">
                      {point.phone}
                    </a>
                  </div>
                )}
                {point.website && (
                  <div className="flex items-center">
                    ...
                    <a href={point.website} target="_blank" rel="noopener noreferrer" className="text-sm hover:underline">
                      Website
                    </a>
                  </div>
                )}
