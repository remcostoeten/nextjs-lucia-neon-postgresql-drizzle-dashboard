...
import type { FooterColumnProps, FooterContactLinkProps } from './footer.d'
...
function FooterContactLink({
	...
	return (
		<a
			...
			className="text-title hover:text-title-dark trans-300 flex -translate-x-2 items-center"
		>
			<div className="size-5 flex-none items-center justify-center">
				{icon}
			</div>
...
function FooterColumn({ title, links }: FooterColumnProps) {
	return (
		<div className={styles['footer-column']}>
			<div className="heading text-xs leading-tight">{title}</div>
			<div className={styles['wrap-v-regular']}>
				{links.map((link, index) => (
					...
					>
						...
						{link.isBeta && (
							<div className="text-xxs heading flex items-center gap-2">
								<div className="flex size-4 items-center justify-center">
									<NewIcon />
								</div>
...
export default function Footer() {
	return (
		<footer className="z-2 relative px-[3%] pb-px">
			<div className={styles['footer-container-lines']}>
				...
				<div className="relative mx-auto w-full">
					...
					>
						<div className="flex w-full max-w-[680px] flex-col justify-between gap-10 lg:max-w-full">
							<div className="flex flex-col items-start gap-4">
								<RainbowLine small className="footer-rainbow" />

								<div className="heading mb-0 text-xl font-medium leading-[1.7]">
									Notevault
								</div>
